...
import { Linux } from "../assets/projects/Linux";
import { Firebase } from "../assets/projects/Firebase";
import { Git } from "../assets/projects/Git";
    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiReactrouter className="text-7xl" />
        </motion.div>
        <motion.div
          variants={iconVariants(4)}
          initial="initial"
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <Firebase className="text-7xl text-green-500" />
        </motion.div>
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <Python className="text-7xl text-center" />
        </motion.div>
        <motion.div
          variants={iconVariants(4)}
          initial="initial"
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiRstudioide className="text-7xl text-[#75AADB]" />
        </motion.div>
        <motion.div
          variants={iconVariants(3)}
          initial="initial"
